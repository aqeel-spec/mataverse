...
// - - - Example 03
const tuplesThree: [boolean, number, string] = [false, 123, "Niazi"];
const tuplesTwoExact: [boolean, number] = [tuplesThree[0], tuplesThree[1]];
...
*/
const pairTupleCorrect: [string, number] = ["Dhahzad", 1];
...
const readonlyTuple = [1157, "Tomoe2"] as const;
//       OR
